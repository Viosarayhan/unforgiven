  ...
  return (
    <div className="bg-[#a49af6] rounded-b-[60px] px-[151px] pt-16 pb-[100px] mt-[62px] flex flex-col items-start gap-8 relative z-0">
      ...
      <p className="text-lg w-[389px] font-sans text-black">
        Latihan Interview oleh HRD Profesional yang akan membantu kamu
      ...
      <img src="/src/assets/Group 1069.svg" alt="Illustration" className="absolute top-0.5 right-[150px] w-[476px] h-[476px] bottom-[100px]" />
    </div>
  );
}
