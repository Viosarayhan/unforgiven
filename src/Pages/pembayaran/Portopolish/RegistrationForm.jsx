...
export default function RegistrationForm({ onSave }) {
  ...
  const handleSubmit = async (event) => {
    ...
    formData.append("program", "PortoPolish");
    ...
    try {
      ...
      if (response.ok) {
        ...
        onSave({ name, email, phone, mentor: selectedMentor, date: selectedDate, time: selectedTime, program: "PortoPolish" });
      } else {
...
function MentorSelection({ selectedMentor, setSelectedMentor }) {
  const mentors = [
    { value: 'tiara', name: 'Tiara Dewi', role: 'Portfolio Consultant', photo: '/public/assetsvivit/5d9783cb0a04030c4556d7079ddf57af.png' },
    { value: 'siska', name: 'Siska Larasati', role: 'Portfolio Consultant', photo: '/public/assetsvivit/2f1ba397127e4944daa182d5fa83e820.png' },
    { value: 'andi', name: 'Andi Wirawan', role: 'Portfolio Specialist', photo: '/public/assetsvivit/4d45e0232a205087c7b514010ab84cac.png' },
  ];
