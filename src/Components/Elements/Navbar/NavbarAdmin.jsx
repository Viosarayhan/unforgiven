  ...
  return (
    <nav className=' fixed top-0 left-0 z-50 w-full h-16px px-[150px] py-2.5 bg-[#4c37ee] shadow justify-between items-center inline-flex'>
        ...
        <ul className='h-[19px] justify-start items-center gap-5 inline-flex'>
          ...
          <Link to='/dataregister' className='justify-center items-center gap-2.5 flex'>
            <li className='text-[#fffff0] text-base font-semibold font-sans leading-[19px] hover:text-[#fb6816] transition border-b-2 border-[#4c37ee] hover:border-[#fb6816] cursor-pointer '>Login User</li>
          </Link>
          <Link to='/daftarcourse' className='justify-center items-center gap-2.5 flex'>
            <li className='text-[#fffff0] text-base font-semibold font-sans leading-[19px] hover:text-[#fb6816] transition border-b-2 border-[#4c37ee] hover:border-[#fb6816] cursor-pointer '>Booking Class</li>
          </Link>
          <Link to='/datapeserta' className='justify-center items-center gap-2.5 flex'>
            <li className='text-[#fffff0] text-base font-semibold font-sans leading-[19px] hover:text-[#fb6816] transition border-b-2 border-[#4c37ee] hover:border-[#fb6816] cursor-pointer '>Payment</li>
          </Link>
          <Link to='/dataartikel' className='justify-center items-center gap-2.5 flex'>
            <li className='text-[#fffff0] text-base font-semibold font-sans leading-[19px] hover:text-[#fb6816] transition border-b-2 border-[#4c37ee] hover:border-[#fb6816] cursor-pointer '>Data Article</li>
          </Link>
        </ul>
