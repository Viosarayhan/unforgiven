...
export default function RegistrationForm({ onSave }) {
  ...
  const handleSubmit = async (event) => {
    ...
    formData.append("program", "CareerStarterKit");
...
function MentorSelection({ selectedMentor, setSelectedMentor }) {
  const mentors = [
    { value: 'tiara', name: 'Tiara Dewi', role: 'Career Starter Consultant', photo: '/public/assetsvivit/5d9783cb0a04030c4556d7079ddf57af.png' },
    { value: 'siska', name: 'Siska Larasati', role: 'Career Starter Consultant', photo: '/public/assetsvivit/2f1ba397127e4944daa182d5fa83e820.png' },
